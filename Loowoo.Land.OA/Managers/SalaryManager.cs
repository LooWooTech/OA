...
namespace Loowoo.Land.OA.Managers
{
    public class SalaryManager : ManagerBase
    {
        ...
        private static readonly string[] LsgColumns = "序号,帐号,工号,姓名,工资,岗位津贴,工龄工资,加班,补贴,车贴,学历,冷饮费,车贴,应发工资,养老保险,救助金5元/月,失业保险0.5%,补缴公积金,扣除,公积金,扣款合计,应发,个调税,实发工资".Split(',').ToArray();
